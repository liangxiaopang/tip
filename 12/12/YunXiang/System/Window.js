...
function Window(config)
{
	if(!appendWindowBorder)
	{
		...
		Desktop.GetDom().appendChild(windowBorder);
		Desktop.GetDom().appendChild(dropDiv);
	}
	...
	if(config.Title!=undefined)
	{
		...
		if(config.Title.InnerHTML!=undefined) _title.InnerHTML = config.Title.InnerHTML;
	}
	...
	domTitle.childNodes[1].innerHTML = _title.InnerHTML;
	...
	This.MoveEx("left|top",This.GetLeft(),This.GetTop())
